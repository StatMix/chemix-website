...
AIC(qc.fit6nonlin)
```
Prior to interpreting the data, it is important to examine the residual plots. For both models, the residuals appear to generally follow the QQ plot and appear to be evenly scattered in the Residuals vs Fitted visualization. The linear model is similar to the examples above and carries the same assumptions. 
