...
(mcmc_intervals(
  ...
  point_est = "mean",
  prob_outer = 0.95,
  pars = c("b_RIDAGEYR_sc", "b_BMXWAIST_sc", "b_BMXHT_sc", "b_BMXWT_sc")) +
...
model_recap <- data.frame(beta_dists, post_means, post_inters)
knitr::kable(model_recap, col.names = c("$\\beta_{Age}$ Distributions",
                           "Posterior Means",
                           "Intercepts"))
```
