...
We will verify that our data meets all the assumptions above in Section: [Model Diagnostics](#Model_Diagonostics_and_Evaluations).
...
Interpret coefficient of `income10`: At the mean value of age `r round(mean(nhanes_income$RIDAGEYR),3)`,  the BMI of an individual in income category 10 is expected to be 0.161 lower than the BMI of an individual in income category 1 (baseline category).
