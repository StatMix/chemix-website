...
*Model Interpretation*:
-   Intercept: The intercept `r round(coef(lm_category)[1],3)` means that for people in the baseline income category (income category 1 corresponding to a household income of 0 to 4,999 dollars), the BMI is expected to be `r round(coef(lm_category)[1],3)` on average.
