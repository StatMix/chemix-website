...
ggplot(nhanes1518, aes(x=RIDAGEYR)) + 
  geom_histogram(binwidth=1, color="black", fill="white")+ # Change the width of bins as well as the color
...
ggplot(df, aes(x = RIDAGEYR, y = BMXBMI, color = income, alpha=0.5)) + 
  geom_point() + 
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE)+
  labs(x = "BMXWAIST", y = "BMXBMI") + 
