...
In this tutorial, we are interested in predicting log BMI using phalate measurements from urine samples for those above 18 years of age.
...
Using the Dirichlet distribution as our prior, we can use a similar formula as WQS for Bay
